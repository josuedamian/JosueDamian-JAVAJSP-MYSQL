...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        vendedor = vjc.findByEmailAndDni(txtUser.getText(), txtPassword.getText());
        if (vendedor !=null) {
            dispose();
            pf.txtIdVendedor.setText(vendedor.getIdVendedor().toString());
            pf.setVisible(true);
        }else{
        JOptionPane.showMessageDialog(null, "Vendedor no registrado", "Advertencia", JOptionPane.WARNING_MESSAGE);
        }
        } catch (Exception e) {
